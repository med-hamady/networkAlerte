...
// consumed = clients installés supervisés (roster UISP, hors supervision exclus),
...
export interface RocketCapacity {
  ...
  name: string
  family: 'ltu' | 'airmax'
  current_clients: number               // installés SUPERVISÉS (hors supervision exclus)
  out_of_supervision_clients: number    // listés par UISP mais hors supervision — exclus de la charge
