...
# Déploiement standard (7 conteneurs : postgres + backend + frontend +
# scheduler[fast] + scheduler-heavy + scheduler-ping-lr + netflow-collector). Le backend
