...
# Déploiement standard (10 conteneurs : postgres + backend + frontend +
# scheduler[fast] + scheduler-heavy + scheduler-ping-lr + scheduler-poll-af60 +
# scheduler-poll-ltu + scheduler-poll-airos + netflow-collector). Le backend
