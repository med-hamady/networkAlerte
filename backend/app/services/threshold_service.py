...
THRESHOLD_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "airmax_backhaul_capacity_min_mbps": {
        "label": "Lien P2P airMAX — plancher de capacité totale",
        "category": "p2p_link",
        "unit": "Mbps",
        "type": float,
        "min": 0,
    ...
    "p2p_link_substandard_failure_threshold": {
        "label": "Lien P2P airMAX dégradé — cycles consécutifs avant incident",
        "category": "antiflap",
        "unit": "cycles",
        "type": int,
        "min": 0,
...
CATEGORY_LABELS: dict[str, str] = {
    ...
    "p2p_link":     "Liaison P2P (backhaul airMAX inter-sites)",
